  ...
  return (
    <section id="contact" className="py-32 px-6 md:px-12 bg-black">
      <div className="max-w-[900px] mx-auto text-center">
        ...
        <div className="mb-12">
          <h2 className="font-sans font-extrabold uppercase leading-[0.95] tracking-[-0.02em]" style={{ fontSize: "clamp(48px, 12vw, 100px)" }}>
          ...
          <div className="marquee-container">
            <div className="marquee-content">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  AVAILABLE FOR WORK · SENIOR ENGINEER · AI SPECIALIST · REMOTE READY ·
                </span>
              ))}
            </div>
          </div>
